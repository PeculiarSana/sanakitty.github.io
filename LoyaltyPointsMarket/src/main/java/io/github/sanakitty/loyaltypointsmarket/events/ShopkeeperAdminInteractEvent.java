...
public class ShopkeeperAdminInteractEvent extends Event
{
	...
	public ShopkeeperAdminInteractEvent(LoyaltyPointsMarket plugin, LivingEntity entity, Player player)
	{
		this.plugin = plugin;
		debug = plugin.debug;
	...
	/** Gets the Player who interacted with a Shopkeeper while in admin mode.
	 * 
	 * @return Player
	 */
